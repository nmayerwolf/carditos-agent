export const WELCOME_MSG =
  'Soy Carditos, el asistente de rugby del club. Te puedo ayudar con cinco cosas concretas:\n\n' +
  ...
  '*Armado de fixture* — decime los clubes, canchas disponibles y categoría, y te armo el fixture de la jornada.\n\n' +
  '¿Qué categoría entrenás?';

export const ASK_NAME_MSG =
...
export const STILL_PENDING_MSG = 'Tu solicitud sigue en revisión. Te avisamos cuando esté lista.';
